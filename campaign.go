...
type CampaignSetting struct {
	...
	AppVendor                           string          `xml:"appVendor,omitempty"`
	...
	UniversalAppBiddingStrategyGoalType string          `xml:"universalAppBiddingStrategyGoalType,omitempty"`
	Details                             []TargetDetails `xml:"details,omitempty"`
}
type TargetDetails struct {
	CriterionTypeGroup string `xml:"criterionTypeGroup,omitempty"`
	TargetAll          bool   `xml:"targetAll,omitempty"`
}

type CampaignAppSetting struct {
	UniversalAppBiddingStrategyGoalType string `xml:"biddingStrategyGoalType,omitempty"`
	AppId                               string `xml:"appId,omitempty"`
	AppVendor                           string `xml:"appVendor,omitempty"`
	Description1                        string `xml:"description1,omitempty"`
	Description2                        string `xml:"description2,omitempty"`
...
type BiddingScheme struct {
	...
	TargetCpa          *TargetCpa `xml:"targetCpa,omitempty"`
	BidCeiling         *TargetCpa `xml:"bidCeiling,omitempty"`
}
type TargetCpa struct {
	Amount int64 `xml:"microAmount,omitempty"`
}
...
type Campaign struct {
	...
	Errors                         []error                         `xml:"-"`
	UniversalAppCampaignInfo       *CampaignAppSetting             `xml:"universalAppCampaignInfo,omitempty"`
}
